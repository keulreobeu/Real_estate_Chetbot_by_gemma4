...
- Evaluate the post-finetuning run `baseline-gemma4-2b-r3` against the frozen pre-finetuning GO snapshot
...
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\train.log`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\valid_predictions.csv`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\grounded_holdout_predictions.csv`
...
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\valid_eval.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\grounded_holdout_eval.json`
...
- `data\qa\finetuning_runs\baseline-gemma4-2b-r3\notes.md`
