...
- Evaluate the post-finetuning run `baseline-gemma4-2b-r4` against the frozen pre-finetuning GO snapshot
...
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\manifest.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\config.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\train.log`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\valid_predictions.csv`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\grounded_holdout_predictions.csv`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\edge_safety_holdout_predictions.csv`
...
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\valid_eval.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\grounded_holdout_eval.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\edge_safety_holdout_eval.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\post_train_summary.json`
- `data\qa\finetuning_runs\baseline-gemma4-2b-r4\notes.md`
